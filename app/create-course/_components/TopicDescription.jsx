...
export default function TopicDescription() {
  ...
  return (
    <div className='mx-5 md:mx-20 lg:mx-44 p-10 bg-gradient-to-r from-blue-50 via-white to-blue-50 shadow-lg rounded-lg'>
      <h1 className='text-2xl font-bold text-center mb-8 text-gray-800'>Generate Your Course</h1>

      {/* Input Topic */}
      <div className='mt-5'>
        <label className='block mb-2 text-lg font-medium text-gray-700 flex items-center gap-2'>
          <Edit className="w-5 h-5 text-blue-600" /> Enter the topic of the course you want to generate
          <span className='block text-sm text-gray-500'>(e.g., Python, building a car, cooking a sandwich, learning Japanese)</span>
        </label>
        <Input 
      ...
      <div className='mt-8'>
        <label className='block mb-2 text-lg font-medium text-gray-700 flex items-center gap-2'>
          <FileText className="w-5 h-5 text-blue-600" /> Tell us more about your course (optional)
        </label>
        <Textarea 
